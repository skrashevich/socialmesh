...
### Safety Features
- One-tap SOS emergency broadcast
- Geofence alerts when contacts leave an area
- Low battery warnings for your devices
- Traceroute to diagnose connectivity

### Full Device Control
Configure every aspect of your Meshtastic radio:
- LoRa settings (region, frequency, power)
- Position broadcasting intervals
- Display and power management
- Network and MQTT bridging
...
For those who value digital privacy—no accounts, no tracking, no data collection.
...
## What's New (Version Notes Template)

### What's New in [VERSION]

**Improvements**
- Config screens now load instantly even when disconnected
- Cached device settings display immediately

**Bug Fixes**
- Fixed infinite loading on config screens when offline
