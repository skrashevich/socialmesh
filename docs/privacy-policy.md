...
- **No Account Required**: We do not require you to create an account or provide personal information to use the App.
- **No Message Storage**: Your messages are transmitted directly between devices via the Meshtastic mesh network. We do not have access to, store, or process your messages on any server.
...
- **No Analytics or Tracking**: We do not use analytics services to track your behavior within the App.
...
We use Firebase Crashlytics to collect crash reports to improve app stability. This may include:
- Device type and operating system version
- App version
- Crash logs and stack traces
- Anonymous installation identifiers

No personal information or message content is included in crash reports.
...
Since we don't collect your data, there's no data to secure on our servers. Your local data is protected by your device's built-in security features.

## Children's Privacy

Our App does not knowingly collect any personal information from children under the age of 13. Since we don't collect personal information from any users, this applies universally.
...
Since we don't collect personal data, there is no personal data to access, correct, or delete. You can clear all local app data at any time through the App's settings.

## Contact Us

If you have any questions about this Privacy Policy, please contact us at:

**Email**: privacy@socialmesh.app  
