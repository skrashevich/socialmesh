...
# Note: toneName should match the displayName for clarity (the RTTTL string can have any valid name)
BUILTIN_PRESETS = [
    {
        'filename': '_builtin_meshtastic_default',
        'displayName': 'Meshtastic Default',
        'toneName': 'Meshtastic Default',
        'artist': 'Meshtastic',
        'rtttl': 'MeshDefault:d=32,o=5,b=565:f6,p,f6,4p,p,f6,p,f6,2p,p,b6,p,b6,p,b6,p,b6,p,b,p,b,p,b,p,b,p,b,p,b,p,b,p,b,1p.,2p.,p',
        'builtin': True,
    },
    {
        'filename': '_builtin_nokia',
        'displayName': 'Nokia Ringtone',
        'toneName': 'Nokia Ringtone',
        'artist': 'Nokia',
    ...
    },
    {
        ...
        'toneName': 'Zelda Get Item',
        'artist': 'Nintendo',
        'rtttl': 'ZeldaItem:d=16,o=5,b=120:g,c6,d6,2g6',
        'builtin': True,
    },
    {
        ...
        'toneName': 'Mario Coin',
        'artist': 'Nintendo',
        'rtttl': 'MarioCoin:d=8,o=6,b=200:b,e7',
        'builtin': True,
    },
    {
        'filename': '_builtin_mario_powerup',
        'displayName': 'Mario Power Up',
        'toneName': 'Mario Power Up',
        'artist': 'Nintendo',
        'rtttl': 'MarioPwrUp:d=16,o=5,b=200:g,a,b,c6,d6,e6,f#6,g6,a6,b6,2c7',
        'builtin': True,
    },
    {
        'filename': '_builtin_mario_theme',
        'displayName': 'Mario Theme',
        'toneName': 'Mario Theme',
        'artist': 'Nintendo',
        'rtttl': 'MarioTheme:d=4,o=5,b=100:16e6,16e6,32p,8e6,16c6,8e6,8g6,8p,8g',
        'builtin': True,
    },
    {
        ...
        'toneName': 'Morse CQ',
        'artist': None,
        'rtttl': 'MorseCQ:d=16,o=6,b=120:8c,p,c,p,8c,p,c,4p,8c,p,8c,p,c,p,8c,8p',
        'builtin': True,
    },
    {
        'filename': '_builtin_simple_beep',
        'displayName': 'Simple Beep',
        'toneName': 'Simple Beep',
        'artist': None,
        'rtttl': 'SimpleBeep:d=4,o=5,b=120:c6,p,c6',
        'builtin': True,
    },
    {
        ...
        'toneName': 'Alert',
        'artist': None,
        'rtttl': 'Alert:d=8,o=6,b=140:c,e,g,c7,p,c7,g,e,c',
        'builtin': True,
    },
    {
        ...
        'toneName': 'Ping',
        'artist': None,
        'rtttl': 'Ping:d=16,o=6,b=200:e,p,e',
        'builtin': True,
    },
    {
