...
/// Mock data for device shop - used until Firebase functions are set up
class MockShopData {
  static final List<ShopSeller> sellers = [
    ShopSeller(
      id: 'lilygo',
      name: 'LilyGO',
      description:
          'Official LilyGO store - Premium Meshtastic-compatible devices with cutting-edge LoRa technology.',
    ...
    ShopSeller(
      ...
      name: 'RAK Wireless',
      description:
          'RAK Wireless - Leading IoT solutions provider with professional-grade Meshtastic hardware.',
    ...
    ShopSeller(
      ...
      description:
          'Heltec - Innovative LoRa solutions with integrated displays and WiFi connectivity.',
    ...
    ShopSeller(
      ...
      name: 'SenseCAP',
      description:
          'SenseCAP by Seeed Studio - Enterprise-grade sensors and Meshtastic devices.',
    ...
    ShopSeller(
      ...
      description:
          'Rokland - Premium antennas and accessories for optimal Meshtastic range.',
    ...
    ShopSeller(
      ...
      name: 'Muzi Works',
      description:
          'Custom 3D printed enclosures and cases for Meshtastic devices.',
  ...
  static final List<ShopProduct> products = [
    ...
    ShopProduct(
      ...
      name: 'T-Beam Supreme',
      description:
          '''The T-Beam Supreme is LilyGO's flagship Meshtastic device, featuring the powerful ESP32-S3 processor with 16MB flash and 8MB PSRAM. 
...
Perfect for outdoor enthusiasts, emergency preparedness, and off-grid communication.''',
      shortDescription:
          'Flagship ESP32-S3 Meshtastic node with GPS and display',
    ...
    ShopProduct(
      ...
      description:
          '''Complete modular Meshtastic solution with the powerful nRF52840 processor.
...
Ultra-low power consumption makes it ideal for solar-powered installations.''',
      ...
      hardwareVersion: '2.0',
      purchaseUrl:
          'https://store.rakwireless.com/products/wisblock-meshtastic-kit',
    ),
    ShopProduct(
      id: 'heltec-v3',
      sellerId: 'heltec',
      ...
      description:
          '''The Heltec LoRa 32 V3 is an affordable yet capable Meshtastic node.
...
Includes mounting bracket and N-type to SMA adapter.''',
      ...
      category: DeviceCategory.antenna,
      ...
      isActive: true,
      isFeatured: false,
      frequencyBands: [FrequencyBand.us915],
      rating: 4.8,
      reviewCount: 156,
      salesCount: 890,
      viewCount: 5600,
...
6dBi omnidirectional gain for 360° coverage. Perfect for rooftop or balcony installations.''',
      ...
      isActive: true,
      isFeatured: false,
      frequencyBands: [FrequencyBand.eu868],
      rating: 4.7,
      reviewCount: 78,
      salesCount: 420,
      viewCount: 3200,
...
Compatible with T-Beam and other ESP32 boards. Includes ceramic antenna for reliable reception.''',
      ...
      category: DeviceCategory.module,
...
Perfect for solar-powered nodes. Excellent visibility in direct sunlight.''',
  ...
  static final List<ProductReview> reviews = [
    // T-Beam Supreme reviews
    ProductReview(
      id: 'review-1',
      ...
      body:
          'The T-Beam Supreme exceeded my expectations. GPS lock is fast, display is crisp, and battery life is excellent. Setup was straightforward with the Meshtastic app.',
    ...
    ProductReview(
      ...
      body:
          'Used this on a 3-day hiking trip. Battery lasted the entire time with GPS on. Could communicate with my group even when we were several km apart in the mountains.',
      isVerifiedPurchase: true,
      helpfulCount: 32,
    ...
    ProductReview(
      ...
      body:
          'Overall a great device. The only reason I\'m giving 4 stars is the plastic case feels a bit flimsy. Consider getting a protective case. Performance-wise, it\'s excellent.',
      isVerifiedPurchase: true,
      helpfulCount: 18,
    ...
    ProductReview(
      ...
      body:
          'For \$20, you can\'t beat this! Yes, it doesn\'t have GPS, but for a home base station or testing, it\'s perfect. Works great with Meshtastic.',
      isVerifiedPurchase: true,
      helpfulCount: 67,
    ...
    ProductReview(
      ...
      body:
          'Perfect for beginners. Easy to flash and configure. Display is small but readable. Would recommend adding an external antenna for better range.',
      isVerifiedPurchase: true,
      helpfulCount: 28,
      createdAt: DateTime(2024, 10, 15),
    ),
    // RAK WisBlock reviews
    ProductReview(
      id: 'review-6',
      ...
      body:
          'The modular design is fantastic. I\'ve added GPS, environmental sensors, and a larger battery. Battery life is incredible - my solar node has been running for months without issues.',
      isVerifiedPurchase: true,
      helpfulCount: 54,
  ...
  static List<ShopProduct> getFeaturedProducts() {
    return products.where((p) => p.isFeatured).toList();
  }

  static List<ShopProduct> getNewArrivals() {
    final sorted = List<ShopProduct>.from(products)
      ..sort((a, b) => b.createdAt.compareTo(a.createdAt));
    return sorted.take(10).toList();
  }

  static List<ShopProduct> getBestSellers() {
    final sorted = List<ShopProduct>.from(products)
      ..sort((a, b) => b.salesCount.compareTo(a.salesCount));
    return sorted.take(10).toList();
  }

  static List<ShopProduct> getOnSale() {
    return products.where((p) => p.isOnSale).toList();
  }

  static List<ShopProduct> getByCategory(DeviceCategory category) {
    return products.where((p) => p.category == category).toList();
  }

  static ShopProduct? getProduct(String id) {
    try {
  ...
  static List<ShopSeller> getOfficialPartners() {
    return sellers.where((s) => s.isOfficialPartner).toList();
  }

  static ShopSeller? getSeller(String id) {
    try {
  ...
  static List<ShopProduct> getSellerProducts(String sellerId) {
  ...
  static List<ShopProduct> searchProducts(String query) {
  ...
  static Map<int, int> getReviewStats(String productId) {
